    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color: black; border-bottom: 2px solid green;">
        <div class="container-fluid container-lg">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="404.html"><i class="fas fa-home me-1"></i> Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="game.html"><i class="fas fa-gamepad me-1"></i> Game Page</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="message.html"><i class="fas fa-envelope me-1"></i> Messages</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="settings.html"><i class="fas fa-cog me-1"></i> Account Settings</a>
                    </li>
                </ul>
            </div>
        </div>
