            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item" id="home-nav-item">
                        <a class="nav-link text-white" href="/public/views/404.php"><i class="fas fa-home me-1"></i> Home</a> <!--need to verify correct paths -->
                    </li>
                    ...
                    <li class="nav-item" id="message-nav-item">
                        <a class="nav-link text-white" href="/public/views/message.php"><i class="fas fa-envelope me-1"></i> Messages</a> <!--need to verify correct paths -->
                    </li>
                    <li class="nav-item" id="accountSettings-nav-item">
                        <a class="nav-link text-white" href="/public/views/accountSettings.php"><i class="fas fa-cog me-1"></i> Account Settings</a> <!--need to verify correct paths -->
                    </li>
                </ul>
            </div>
        </div>
