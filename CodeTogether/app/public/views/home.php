            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item" id="home-nav-item">
                        <a class="nav-link text-white" href="404.html"><i class="fas fa-home me-1"></i> Home</a> <!--need to verify correct paths -->
                    </li>
                    ...
                    <li class="nav-item" id="message-nav-item">
                        <a class="nav-link text-white" href="message.html"><i class="fas fa-envelope me-1"></i> Messages</a> <!--need to verify correct paths -->
                    </li>
                    <li class="nav-item" id="accountSettings-nav-item">
                        <a class="nav-link text-white" href="settings.html"><i class="fas fa-cog me-1"></i> Account Settings</a> <!--need to verify correct paths -->
                    </li>
                </ul>
            </div>
        </div>
