...
<head>
    ...
    <link rel="stylesheet" href="/public/css/core/home.css">
    <link rel="stylesheet" href="/public/css/page/search.css">
</head>
                            ...
                            <?php else: ?>
                                ...
                                <?php foreach ($users as $user): ?>
                                    ...
                                    <div class="profile-card mb-3 p-3 d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5 class="mb-1 "><?= htmlspecialchars($user->getUserName()) ?></h5>
                                            <small class="d-block  mb-2"><?= htmlspecialchars($user->getEmail()) ?></small>
