...
<body class="bg-black text-white antialiased">
    ...
    <div class="container">
        <div class="flex items-center justify-center min-h-screen relative z-10 p-4">
            <div class="card-matrix px-10 py-24 mx-auto text-center rounded-lg w-full max-w-2x1 transition-all duration-300">
                <div class="card-body">
                    <h1 class="text-9xl font-extrabold mb-6 text-matrix-green tracking-widest">404</h1>
                    <h2 class="text-3xl sm:text-4xl font-mono mb-4 text-faint-green animate-pulse">It is...Inevitable.</h2>
                    <p class="text-base sm:text-lg font-mono mb-8 text-white-400">But that is how it is with you people. You don't care how it works...<br>just that it works.<br> And HERE WE ARE... looking at this 404 error in disbelief.</p>
                </div>
