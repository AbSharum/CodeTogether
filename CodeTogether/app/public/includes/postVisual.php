...
<div class="post-card">
    ...
    <div class="d-flex align-items-start gap-2">
      ...
      <div class="dropdown post-options">
        ...
        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton<?= $post->getPostID(); ?>">
          ...
          <?php if ((int) $post->getUserID() === (int) ($_SESSION['usercreds']['userID'] ?? 0) || $_SESSION['usercreds']['role'] === 'moderator'): ?>
            <li>
  ...
  <?php if (!empty($post->getContents())): ?>
    ...
    <form action="index.php?action=editPost" method="POST" class="edit-post-form d-none"
      id="edit-form-<?= $post->getPostID(); ?>">
      <input type="hidden" name="post_id" value="<?= $post->getPostID(); ?>">
